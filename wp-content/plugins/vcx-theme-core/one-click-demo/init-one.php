...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name    = 'eplano_options'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		 ...
		 * @var string
		 */
		public $content_demo_file_name  = 'demo-content.xml';
