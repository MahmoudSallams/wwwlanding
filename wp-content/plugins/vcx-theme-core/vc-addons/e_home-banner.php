...
add_shortcode( 'vcx_home_banner', 'vcx_home_banner_function');
...
function vcx_home_banner_function($atts)
{
    ...
    $vcx_chris_attr = ($vcx_chris_en == 'yes') ? 'csi-banner-christmas' : '';


    //Show Particle Effect
    $vcx_banner_attr = ($vcx_particle_en == 'yes') ? 'particle' : 'simple';
    ...
    $button_area_html= '<div class="action-area csi-btn-area">
                        '.$button_html1.'
                        '.$button_html2.'
                        '.$button_html3.'
                        '.$button_html4.'
    ...
    $banner_text = '<div class="csi-banner-content csi-banner-content-'.$banner_align_class.' ">
                    '.$pre_title_html.'
                    '.$title_html.'
                    '.$title_two_html.'
                    '.$post_title_html.'
    ...
    $output = '<section>
                <div id="csi-banner-'.esc_attr($vcx_banner_attr).'"  class="csi-banner csi-banner-'.esc_attr($vcx_banner_attr).'  '.esc_attr($vcx_chris_attr).' ">
...
if (class_exists('WPBakeryVisualComposerAbstract')) {
    vc_map(array(
        "name" => esc_html__("Header Banner", 'vcx-theme-core'),
        "base" => "vcx_home_banner",
        "class" => "",
