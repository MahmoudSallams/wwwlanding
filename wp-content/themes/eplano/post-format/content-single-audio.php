...
<article id="post-<?php the_ID(); ?>" <?php post_class('csi-single-post'); ?>>
    <header>
        ...
        <div class="text-area">
            ...
            <?php $csx_post_audio = get_post_meta(get_the_ID(),'__vcx__post-format-audio',true); ?>

            <?php if(!empty($csx_post_audio)): ?>
                <div class="csx-featured-wrap csx-post-audio">
                    <?php echo balanceTags(wp_kses_post($csx_post_audio)); ?>
                </div>
            <?php endif; ?>
