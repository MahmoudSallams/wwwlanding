...
/************************************************************************
 * Eplano functions and definitions
 *************************************************************************/
define('EPLANO_NAME', wp_get_theme()->get( 'Name' ));
define('EPLANO_STYLE', get_template_directory_uri().'/assets/css/');
define('EPLANO_SCRIPT', get_template_directory_uri().'/assets/js/');
define('EPLANO_VENDOR', get_template_directory_uri().'/assets/vendor/');
define('EPLANO_URI', get_template_directory_uri().'/');
